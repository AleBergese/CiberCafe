namespace VistaCiber1
{
    partial class EliminarEmpleado
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Seleccione el ID del empleado a eliminar";
